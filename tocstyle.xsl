                ...
                <tr>
                  <td style="text-align: right;">
                    <div style="width: 70%; padding: 10px; background-color: #ffffff; border: 1px solid #efefef; display: inline-block; margin: 5px">
                      <img src="C:/Users/ksara/Desktop/pgreport/images/img.jpeg" alt="img" style="width: 100%; height: auto;  display: inline-block;" />
                    </div>
                  </td>
                  <td style="width: 50%; text-align: left;">

                    <div style="text-align: left; margin-top: 10px; padding-left: 20px; margin-bottom: 30px; ">
                      <img src="C:/Users/ksara/Desktop/pgreport/images/logo.png" alt="img" style="width: 150px; height: auto; "/>
                    </div>
